            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.setSelectedItem = function (id, dontRemove) {
                    ...
                    if (!dontRemove && exists) {
                    	...
                    	angular.forEach($rootScope.canNotBeReachedArray, function (value, index) {
  				          if(value.id == id){
  				        	  alert("This item is selected in Can Not be Reached");
  				        	  isExist = true;
  				          }
  				        });
                      	if(!isExist){
                      		$scope.selectedModel.push(finalObj);
                              $rootScope.canBeReachedArray = $scope.selectedModel;
                              $scope.externalEvents.onItemSelect(finalObj);
                              if ($scope.settings.closeOnSelect) $scope.open = false;
                      	}
...
directiveModule.directive('ngCompareDropdownMultiselect', ['$filter', '$document', '$compile', '$parse','$rootScope',
    function ($filter, $document, $compile, $parse,$rootScope) {
            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.setSelectedItem = function (id, dontRemove) {
                    ...
                    if (!dontRemove && exists) {
                    	...
                    	angular.forEach($rootScope.canBeReachedArray, function (value, index) {
				          if(value.id == id){
				        	  alert("This item is selected in Can Not be Reached");
				        	  isExist = true;
				          }
                    	...
                    	if(!isExist){
                    		$scope.selectedModel.push(finalObj);
                            $rootScope.canNotBeReachedArray = $scope.selectedModel;
                            $scope.externalEvents.onItemSelect(finalObj);
                            if ($scope.settings.closeOnSelect) $scope.open = false;
                    	}
